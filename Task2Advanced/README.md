...
Пайплайн настроен для Github Actions на рабочую ветку future. Выполняется init и plan, далее опциональные кнопки apply и destroy для безопасного внесения изменений. 
